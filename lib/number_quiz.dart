...
import 'package:quiz_app/number_quest.dart';
...
class _NumberQuizState extends State<NumberQuiz> {
  ...
  Future<NumberQuestion> numbQuest;
  ...
  Future<List<NumberQuestion>> getQuestions() async {
    var apiUrl =
    ...
    List<NumberQuestion> numbQuest =
        data.map((data) => NumberQuestion.fromJson(data)).toList();
    return numbQuest;
  }
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: FutureBuilder<List<NumberQuestion>>(
                  future: getQuestions(),
            ...
            FutureBuilder<List<NumberQuestion>>(
              future: getQuestions(),
              builder: (context, snapshot) {
                return snapshot.hasData
                    ? Column(
